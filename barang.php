                     ...
                     <table class="table">
                        ...
                        <tbody>
                          <?php foreach($barang as $b):?>
                            <tr>
                               <th scope="row"><?php echo $b['id_barang'];?></th>
                               <td><?php echo $b['nama_barang'];?></td> 
                               <td><?php echo $b['tanggal'];?></td> 
                               <td><?php echo $b['harga_awal'];?></td> 
                               <td><?php echo $b['deskripsi_barang'];?></td> 
                               <td>
                                 <a href="form_ubah_barang.php?id=<?php echo $b['id_barang'];?>" class="btn btn-primary">Edit</a>

                                 <a href="proses_hapus_barang.php?id=<?php echo $b['id_barang'];?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Ini?')">Hapus</a>
                                </td>
                          </tr>
                          <?php endforeach;?>
</tbody>
...
<center> <a href="form_tambah_barang.php" class="btn btn-info">Tambah!</a></center>
